...
export function WhoOwnsYourData() {
  return (
    <section className="relative py-20 md:py-32 px-4 md:px-6 bg-[#6c44fc] text-white">
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16 md:mb-24">
          ...
          <RevealText delay={0.1}>
            <h3 className="text-3xl md:text-5xl lg:text-7xl xl:text-8xl font-medium tracking-tight mb-6 md:mb-8 leading-[1.1]">
              Seeing those ads made me realize something terrifying.
            </h3>
          </RevealText>
          <RevealText delay={0.2}>
            <p className="text-base md:text-lg lg:text-xl xl:text-2xl text-white/80 max-w-3xl mx-auto font-medium leading-relaxed">
