    ...
    <section className="relative py-32 px-6 overflow-hidden bg-[#f3f4f8] text-[#111111]">
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="text-center mb-12">
          <RevealText>
            <h2 className="text-sm font-bold tracking-widest text-[#6c44fc] uppercase mb-4">
              03. The Challenge
            </h2>
          </RevealText>
        ...
        <div className="space-y-6 text-lg md:text-xl text-[#666666] font-medium">
          ...
          <RevealText delay={0.3}>
            <p className="text-[#111111] bg-white p-8 rounded-2xl border border-black/5 shadow-lg mt-8">
